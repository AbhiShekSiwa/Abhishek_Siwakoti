...
<div style="text-align:center; margin-bottom: 2em;">
  <img id="frame-slider-image" src="/assets/annimation/frame001.png" style="max-width: 100%; border: 1px solid #ccc; border-radius: 6px;" />
  <input type="range" id="frame-slider" min="1" max="100" value="1" style="width: 100%; margin-top: 1em;">
</div>
...
<script>
  ...
  frameSlider.addEventListener('input', () => {
    const frameNum = String(frameSlider.value).padStart(3, '0'); // 001, 002, ...
    frameImage.src = `/assets/annimation/frame${frameNum}.png`; // Adjust to .png if needed
  });
</script>
