...
<div class="carousel" id="carousel-2">
  ...
  <div class="carousel-images">
    <img src="/assets/img/asen2803_lab1_loop_plot.png" class="carousel-image active" alt="Loop simulation">
    <img src="/assets/img/asen2803_lab1_gforce_summary.png" class="carousel-image" alt="G-force plot">
    <img src="/assets/img/asen2803_lab1_track_diagram.png" class="carousel-image" alt="Track profile and segment layout">
  </div>
...
<script>
let slideIndices = [1, 1, 1, 1]; // Adjust length if you have more/less carousels
