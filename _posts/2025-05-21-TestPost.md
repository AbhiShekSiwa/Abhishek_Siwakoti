...
<div style="text-align:center; margin-bottom: 2em;">
  <img id="frame-slider-image" src="/assets/annimation/Frame000.png" style="max-width: 100%; border: 1px solid #ccc; border-radius: 6px;" />
  <input type="range" id="frame-slider" min="1" max="64" value="1" style="width: 100%; margin-top: 1em;">
</div>
