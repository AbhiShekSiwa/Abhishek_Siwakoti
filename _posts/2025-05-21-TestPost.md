...
<script>
  ...
  frameSlider.addEventListener('input', () => {
    ...
    // Forward 0–47 → Frame001–Frame048
    // Backward 48–95 → Frame047–Frame001
    if (index < 48) {
      index = index + 1;  // Frame001 to Frame048
    } else {
      index = 96 - index; // Frame047 back to Frame001
    }

    const frameNum = String(index).padStart(3, '0');  // Always 3 digits
